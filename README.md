...
### Buttons
The game will consist of multiple buttons, there will a start button, a reset button and one button for each of the four colours. There may also be a button for turning on
